  ...
  return (
    <>
      <div className={styles.container}>
        <h1>Política de Cookies Geek News</h1>
        ...
        <ul>
          <li>
            Cookies relacionados à conta Se você criar uma conta connosco, usaremos cookies para o gerenciamento do
          ...
          <li>
            Cookies relacionados ao login Utilizamos cookies quando você está logado, para que possamos lembrar dessa
            ação. Isso evita que você precise fazer login sempre que visitar uma nova página. Esses cookies são
          ...
          <li>
            Cookies relacionados a boletins por e-mail Este site oferece serviços de assinatura de boletim informativo
            ou e-mail e os cookies podem ser usados ​​para lembrar se você já está registrado e se deve mostrar
            determinadas notificações válidas apenas para usuários inscritos / não inscritos.
          </li>

          <li>
            Pedidos processando cookies relacionados Este site oferece facilidades de comércio eletrônico ou pagamento e
            alguns cookies são essenciais para garantir que seu pedido seja lembrado entre as páginas, para que possamos
          ...
          <li>
            Cookies relacionados a formulários Quando você envia dados por meio de um formulário como os encontrados nas
            páginas de contacto ou nos formulários de comentários, os cookies podem ser configurados para lembrar os
        ...
        <ul>
          ...
          <li>
            ...
            nossos custos de publicidade e produtos para garantir o melhor preço possível.
          </li>
          ...
          <li>
            ...
            você. Para mais informações sobre o Google AdSense, consulte as FAQs oficiais sobre privacidade do Google
            AdSense.
          </li>
        ...
        <p>
          O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Geek News oferece no site e
        ...
        <ul>
          ...
          <li>
            ...
            <a style={{ color: 'inherit !important', textDecoration: 'none !important' }} href="https://jogoshoje.io">
              jogos de hoje
            </a>{' '}
          ...
          <li>
            C - Não causar danos aos sistemas físicos hardwares e lógicos softwares do Geek News, de seus fornecedores
        ...
        <p>
          Esta política é efetiva a partir de <strong>Novembro</strong>/<strong>2021</strong>.
        </p>
      </div>
    </>
  );
